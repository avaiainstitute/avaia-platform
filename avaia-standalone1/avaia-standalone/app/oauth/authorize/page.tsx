...
// AVAIA acting as a minimal OAuth 2.0 authorization-code provider for
// exactly one client: the real IAP custom GPT's Action. The Host consents
// here, once; nothing about their identity depends on a value the model has
...
export default async function OAuthAuthorizePage({
  ...
  // step but can't trigger that failure mode.
  if (!user) {
    return (
      <div className="mx-auto max-w-prose px-5 py-20">
