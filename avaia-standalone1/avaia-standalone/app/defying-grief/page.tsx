...
function ThresholdContent({
  ...
  return (
    <>
      ...
      <p className="mt-4 text-lg text-muted">
        That willingness has a name here. AVAIA calls it{" "}
        <span className="text-ink">Audacity</span>, not a virtue exactly, but the force that
        makes a person insist on their own aliveness in the face of loss.
      </p>
      <p className="mt-4 text-lg text-muted">
