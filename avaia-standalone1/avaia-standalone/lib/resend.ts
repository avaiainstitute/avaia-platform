 ...
 *  strings), several callers across the app interpolate raw Host-typed (or
 *  public-form-typed) text into HTML, escape it so a name or message
 *  containing HTML can't inject markup into a notification email. Exported
 *  so lib/pink/emails.ts and lib/ops/emails.ts reuse this exact function
